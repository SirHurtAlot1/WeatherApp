...
// Night theme styles etc.
const String nightBackgroundImagePath = 'lib/images/night.png';
...
const TextStyle nightMainTempTextStl = TextStyle(
    fontSize: 75, fontWeight: FontWeight.w400, color: nightTextAndIconColor);
const TextStyle nightMainCardTextStl = TextStyle(
    fontSize: 30, fontWeight: FontWeight.w500, color: nightTextAndIconColor);
...
const TextStyle dayMainTempTextStl = TextStyle(
    fontSize: 75, fontWeight: FontWeight.w400, color: dayTextAndIconColor);
const TextStyle dayMainCardTextStl = TextStyle(
    fontSize: 30, fontWeight: FontWeight.w500, color: dayTextAndIconColor);
